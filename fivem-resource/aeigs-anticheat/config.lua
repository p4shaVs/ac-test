...
Config.BrandLogoUrl = GetConvar('aeigs_logo', '')  -- örn. 'https://site/logo.png'
...
-- protection) çalışır. Kapatmak için server.cfg'de: set aeigs_detections "false"
--
...
-- ---------------------------------------------------------------------------
Config.DetectionsEnabled = (GetConvar('aeigs_detections', 'true') == 'true')
...
-- (aeigs_api + '/screenshot/upload'). Yani ayrı bir yükleyici/convar AYARLAMANA
-- GEREK YOK — aeigs_api zaten senin public panel adresin olduğundan görüntü
...
-- ---------------------------------------------------------------------------
Config.ScreenshotUploadUrl = GetConvar('aeigs_ss_upload', '')  -- boş = otomatik (aeigs_api)
...
Config.AdminMenuKey     = GetConvar('aeigs_menu_key', 'F6')  -- boş bırakılırsa kısayol atanmaz
